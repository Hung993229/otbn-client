...
const Instruct = () => {
    return (
        <div className="container-huongDan">
            <h1 className="h1">YeuAi.Online CÓ ĐIỀU GÌ KHÁC BIỆT?</h1>
            ...
            <p>
                ...
                vậy YeuAi.Online đã ra đời!
            </p>
            <h2 className="h2">2. Hội FA (Hội Độc Thân)</h2>
            <p>
                Hãy tự đặt ra câu hỏi nhé, khi nào thì tỉ lệ bạn tìm được người
                yêu cao nhất? <br />
                Làm sao bạn có thể tìm người yêu ở <b>Hội mẹ và bé</b> hay
                <b> Hội những ông chồng không sợ vợ!</b> <br /> Muốn tìm người
                yêu bạn phải tham gia <b>Hội độc thân</b> chứ! <br /> - Vậy làm
                sao để tham gia hội độc thân, ở khu phố mình thì chưa có. Lên
                mạng xã hội tìm thì nhiều người tham gia hội với mục đích câu
                view, câu like bán hàng hoặc nghiêm trọng hơn là dụ dỗ đầu tư
                lừa tiền, lừa tình! <br /> - Tham gia mấy chương trình ghép đôi
                thì toàn ở khoảng cách xa, với mãi mà chưa đến lượt, tính mình
                cũng ngại đám đông, thuê cả dịch vụ mai mối chuyên nghiệp cũng
                chưa đâu vào đâu, thuê cũng có ít tiền đâu, để gặp mặt cũng mấy
                triệu, thậm trí cả chục triệu! Tuy là cam kết đến khi thành công
                mới thôi, nhưng lâu quá thấy cũng chưa hiệu quả! <br /> Vậy bạn
                tham gia Hội FA của YeuAi.Online đi! Tại đây quy tụ toàn những
                người độc thân mà mong muốn tìm người yêu giống bạn! Tỉ lệ bạn
                sớm tìm được người yêu sẽ nhanh hơn đấy! <br /> YeuAi.Online
            ...
            <p>
                ...
                hàng từ YeuAi.Online! <br /> Mục đích phát triển ban đầu của
            ...
            <p>
                Đội ngũ phát triển YeuAi.Online với mong muốn giúp những người
                độc thân sớm tìm được Hạnh Phúc cho riêng mình. Tuy nhiên
                Website chỉ có ý nghĩa khi số lượng người dùng đủ nhiều! Để mọi
                người có nhiều lựa chọn hơn, từ đó tăng tỉ lệ tìm được người bạn
                đời phù hợp yêu cầu! <br /> Chính vì lẽ đó YeuAi.Online rất mong
